...
public class reportePacientes {
    ...
    private ArrayList<Paciente> records = Gestora.admGestora().getListPaciente();

    public reportePacientes(JDesktopPane desktopPane, int itemsPerPage) {
        ...
        tableModel.addColumn("IDHistorial");
    ...
    private void updateTableData() {
        ...
        for (int i = startIndex; i < endIndex; i++) {
            Paciente p = records.get(i);
            tableModel.addRow(new Object[]{(i + 1), p.getIdHistorial(), p.getNombre(), p.getApellidos(), p.getCedula(), p.getDireccion(), p.getTelefono()});
        }
    }
